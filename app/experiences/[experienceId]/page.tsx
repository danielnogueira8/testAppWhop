		...
		return (
			<div className="flex justify-center items-center h-screen px-8">
				<h1 className="text-xl">
					...
					<br />
					<br />
					Experience ID: <strong>{experienceId}</strong>
				</h1>
			</div>
		);
	} catch (error) {
		...
		return (
			<div className="flex justify-center items-center h-screen px-8">
				<div className="text-center">
					<h1 className="text-xl text-red-600 mb-4">Error Loading Experience</h1>
					<p className="text-gray-600 mb-2">
						There was an error loading this experience page.
					</p>
					<p className="text-sm text-gray-500">
						This might be due to invalid permissions or a missing experience.
					</p>
